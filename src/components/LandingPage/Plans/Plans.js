...
const Plans = forwardRef(({ ref, mixpanel }) => {
  ...
  const whatsAppNumber = (payload) => {
    const message = `Hey! I'd like to subscribe to Mejamakan :)  %0a%0aI have *${payload.familyMembers} family members* %0aI would like to subscribe to *package ${payload.packageSelected}* %0aI would like lauk to be delivered for *${payload.planSelected} days*%0aI would like to have *${payload.rice}* with my lauk`;
